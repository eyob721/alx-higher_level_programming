...
class Square:
    ...
    Args:
        size (int): Initial size of the square object.
    ...
    def __eq__(self, other):
        ...
        Args:
            other (obj): The second operand in the comparison.

        Returns:
            True if `other` is a Square object and it area is == with the
    ...
    def __lt__(self, other):
        ...
        Returns:
            True if `other` is a Square object and it area is < the current
