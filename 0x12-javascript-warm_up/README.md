...
- A script that prints three messages about C, Python and Javascript

[2-arguments.js](./2-arguments.js)

- A script that prints a message about the number of arguments passed to it
...
- A script that prints the two arguments passed to it

[5-to_integer.js](./5-to_integer.js)

- A script that prints `My number: <first argument>` if the first argument can
 be converted to an integer

[6-multi_languages_loop.js](./6-multi_languages_loop.js)

- A script that prints messages about C, Python and JavaScript using an array
 and loops

[7-multi_c.js](./7-multi_c.js)

- A script that prints the word `C is fun` x times
...
- A script that computes and prints a factorial, using recursion
...
- A given script where we have to change the value of a property of an object

[13-add.js](./13-add.js)

- A script that exports a function that returns the addition of 2 integers
